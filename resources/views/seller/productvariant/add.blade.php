...
@section("body")
	...
	<div class="box-header with-border">
		<div class="box-title">
			<a title="Go back" href="{{ url('seller/my/products') }}" class="btn btn-sm btn-default"><i class="fa fa-reply" aria-hidden="true"></i></a> {{$findpro->name}}'s Variant
		</div>
	</div>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										{{ $nameofval->values }}@if($nameofval->unit_value !=null){{ $nameofval->unit_value }}@endif
									</td>
									<td>
		    ...
		    <div role="tabpanel" class="tab-pane" id="profile">
    			...
    			@foreach($findpro->subvariants as $key=> $sub)
					<tr>
						...
						<td class="custom-radios align-middle">
