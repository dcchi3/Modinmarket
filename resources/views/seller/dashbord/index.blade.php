    ...
    <div class="row dbrow">
     <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-yellow">
        ...
        <a href="{{ url('seller/my/products') }}" class="small-box-footer">
  ...
  <div class="box box-solid">
    ...
    <div class="box-body height335 overflow-y-scroll">
      <ul class="products-list product-list-in-box">
        @php
        $products = App\Product::orderBy('id', 'desc')->where('vender_id',Auth::user()->id)->take($dashsetting->max_item_pro)->get();
        @endphp
        ...
        <li class="item">
          <div class="product-img">
            ...
            <center>
              <img class="pro-img2" src="{{ url('variantimages/'.$sub->variantimages['image2']) }}" alt="{{ $sub->variantimages['image2'] }}" title="{{ $pro->name }}">
            </center>
            @endif
          </div>
     ...
     <div class="box-footer text-center">
      <a href="{{ url('seller/my/products') }}" class="link-text uppercase"><i class="fa fa-eye"></i> View All Products</a>
    </div>
    <!-- /.box-footer -->
  </div>
</div>
