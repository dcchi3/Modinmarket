<br>
<form method="post" enctype="multipart/form-data" @if(!empty($products)) action="{{url('seller/my/products/'.$products->id)}}" @endif data-parsley-validate class="form-horizontal form-label-left">
                        {{csrf_field()}}
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <input required="" placeholder="Please enter product name" type="text" id="first-name" name="name" value="{{$products->name ?? ''}}" class="form-control">
                      </div>
                      ...
                      <div class="col-md-6">
                        <label>
                         Select Brand: <span class="required">*</span>
                          ...
                          @foreach($brands as $brand)
                           <option value="{{$brand->id}}" {{ $brand->id == $products->brand_id ? 'selected="selected"' : '' }} >{{$brand->name}} </option>
                          @endforeach
                          @endif
                        </select>
                      </div>
                        ...
                        <select required="" name="category_id" id="category_id" class="select2 form-control">
                          ...
                          <option value="{{$category->id}}" {{ $products->category_id == $category->id ? 'selected="selected"' : '' }}> {{$category->title}} </option>
                          @endforeach
                          @endif
                        </select>
                        </div>
                        ...
                        <div class="margin-top-15 col-md-4">
                          ...
                          <select required="" name="child" id="upload_id" class="select2 form-control">
                            ...
                            <option value="{{$category->id}}" {{ $products->child == $category->id ? 'selected="selected"' : '' }}> {{$category->title}} 
                            </option>
                            @endforeach
                            @endif
                          </select>
                        ...
                        <div class="margin-top-15 col-md-4">
                         ...
                         Childcategory:
                          ...
                          <option value="{{$category->id}}" {{ $products->grand_id == $category->id ? 'selected="selected"' : '' }}> {{$category->title}} 
                          </option>
                          @endforeach
                          @endif
                          </select>
                      ...
                      <div class="margin-top-15 col-md-4">
                        ...
                        <select class="form-control" name="w_d" id="">
                          <option>None</option>
                          @for($i=1;$i<=12;$i++)
                            <option {{ $products->w_d == $i ? "selected" : "" }} value="{{ $i }}">{{ $i }}</option>
                          @endfor
                        </select>
                      </div>
                      ...
                      <div class="margin-top-15 col-md-6">
                        ...
                        <input placeholder="Please Enter Tag Seprated By Comma" type="text" id="first-name" name="tags" data-role="tagsinput" value="{{ $products->tags }}" class="form-control">
                      </div>
                      ...
                      <div class="margin-top-15 col-md-12">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input type="text" id="first-name" name="model" class="form-control" placeholder="Please Enter Model Number" value="{{ $products->model }}" >
                          </div>
                          ...
                          <input type="text" id="first-name" name="sku" value="{{ $products->sku }}" placeholder="Please enter SKU" class="form-control">
                          </div>
                       ...
                       <div class="margin-top-15 col-md-12">
                        <label class="switch"> 
                          ...
                          <input {{ $products->tax_r != '' ? "checked" : "" }} type="checkbox" id="tax_manual" class="toggle-input toggle-buttons" name="tax_manual" >
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <input title="Price Format must be in this format : 200 or 200.25" pattern="[0-9]+(\.[0-9][0-9]?)?" required="" type="text" id="first-name" name="price" value="{{$products->vender_price ?? ''}}" class="form-control">
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <input title="Offer price Format must be in this format : 200 or 200.25" pattern="[0-9]+(\.[0-9][0-9]?)?" type="text" id="first-name" name="offer_price" class="form-control" value="{{$products->vender_offer_price ?? ''}}" >
                           <br>
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <div class="input-group">
                            <input pattern="[0-9]+" title="Tax rate must without % sign" {{ $products->tax_r != '' ? "required" : "" }} value="{{ $products->tax_r }}" id="tax_r" type="number" min="0" class="form-control" name="tax_r" placeholder="0">
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <input {{ $products->tax_r != '' ? "required" : "" }} type="text" id="tax_name" class="form-control" name="tax_name" placeholder="Enter Tax Name" value="{{ $products->tax_name }}">
                        </div>
                         ...
                         <div class="margin-top-15 col-md-12">
                          ...
                          <select {{ $products->tax_r == '' ? "required" : "" }} name="tax" class="form-control">
                            ...
                            <option value="{{$tax->id}}" @if(!empty($products)){{ $tax->id == $products->tax ? 'selected="selected"' : '' }}@endif>{{$tax->title}}</option>
                            @endforeach
                          </select>
                          <small class="txt-desc">(Please Choose Yes Then Start Sale This Product )</small>
                           <img src="{{(url('images/info.png'))}}" data-toggle="modals" data-target="#exampleModalCenter" class="height-15"><br>
                        ...
                        <label>
                         ...
                         <input {{ $products->free_shipping == "0" ? '' : "checked" }} class="tgl tgl-skewed" name="free_shipping" id="frees" type="checkbox">
                        ...
                        <input class="tgl tgl-skewed" id="toggle-event2" @if(!empty($products))  <?php echo ($products->featured=='1')?'checked':'' ?> @endif type="checkbox" name="featured">
                        ...
                        <input class="tgl tgl-skewed" id="toggle-event3" type="checkbox"  @if(!empty($products)) <?php echo ($products->status=='1')?'checked':'' ?> @endif>
                        ...
                        <input id="toggle-event4" class="tgl tgl-skewed" type="checkbox"  @if(!empty($products)) <?php echo ($products->cancel_avl=='1')?'checked':'' ?> @endif>
                        <label class="tgl-btn" data-tg-off="Deactive" data-tg-on="Active" for="toggle-event4"></label>
                        <input @if(!empty($products)) value="{{ $products->cancel_avl }}" @else  value="0" @endif type="hidden" name="cancel_avl" id="status4">
                        ...
                        <input id="codcheck" name="codcheck" class="tgl tgl-skewed" type="checkbox"  @if(!empty($products)) <?php echo ($products->codcheck=='1')?'checked':'' ?> @endif>
                       ...
                       <div class="last_btn col-md-6 @if(!empty($products) && $products->return_avbl==1) @else 'display-none' @endif" id="policy">
                        <label>
                        ...
                        <div class="margin-top-15 col-md-12">
                           <button @if(env('DEMO_LOCK') == 0) type="submit" @else disabled="" title="This action is disabled in demo !" @endif class="col-md-4 btn btn-block btn-primary"><i class="fa fa-save"></i> Update Product</button>
                        </div>
