...
@section("body")
 ...
 <div class="box box-pirmary">
      ...
      <div class="box-header">
        ...
        <a href="{{ url('seller/my/products/create') }}" class="btn btn-md btn-success">+ Add Product</a>
      ...
      <div class="box-body">
        ...
        <table id="full_detail_table" class="table table-bordered table-hover width100">
          <thead>
            <tr class="header">
            <th>
                <div class="inline">
                        ...
                        <tr>
                         ...
                         @if(count($product->subvariants)>0)
                          ...
                          <td width="20%">
                            ...
                            <p><b>Store: </b>
                              <span class="font-weight500">{{$product->store_id==''?'Empty':$product->store->name}}</span></p>
                            <p>
                              <b>Brand:</b>
                              <span class="font-weight500">
                                {{$product->brand_id==''?'Empty':$product->brand->name}}
                              </span>
                            </p>
                          ...
                          <td valign="middle">
                            <p><b>Selling Price: </b><i class="fa {{ $defCurrency->currency_symbol }}"></i>{{ $product->price }}</p>
                            @if($product->vender_offer_price !='')
                            <p><b>Selling Offer Price: </b>{{ $product->offer_price }}</p>
                            @endif
                          ...
                          <td>
                            ...
                            <p class="font-weight"><i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                 ...
                                 @endphp
                                   ...
                                   <li role="presentation" class="divider"></li>
                                    ...
                                    <li>
                                      <a href="{{ route('seller.pro.vars.all',$product->id) }}" class=""><i class="fa fa-external-link-square" aria-hidden="true"></i>
                                      View All Variants</a>
                                    </li>
                                    ...
                                    @endforeach
                                     ...
                                     <li role="presentation">
                                      <a href="{{ route('seller.add.var',$product->id) }}">
                                        <i class="fa fa-plus" aria-hidden="true"></i>Add Variant
                                      </a>
                                    </li>
                                      <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('seller/my/products/'.$product->id.'/edit')}}">
                                  ...
                                  if($comm->type=='f'){
                                     ...
                                     $price = $product->vender_price + $comm->rate;
                                      ...
                                      if($product->vender_offer_price != null){
                                        ...
                                        $offer =  $product->vender_offer_price;
                                      }
    ...
    <div id="{{ $product->id }}pro" class="delete-modal modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
               <form method="post" action="{{url('seller/my/products/'.$product->id)}}" class="pull-right">
                             {{csrf_field()}}
                             {{method_field("DELETE")}}
                <button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
                <button type="submit" class="btn btn-danger">Yes</button>
