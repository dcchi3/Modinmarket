	...
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			<div class="box-title">
				...
				<a title="Go back to all products" href="{{ url('seller/my/products') }}" class="btn btn-sm btn-default"><i class="fa fa-reply" aria-hidden="true"></i></a> {{$pro->name}}'s Variant
				...
				@php
				 ...
				 if(isset($pro->grand_id) && $pro->grand_id != 0){
				 	$getchildaname = App\Grandcategory::where('id',$pro->grand_id)->first()->title;
				 }
			...
			@if(isset($pro->grand_id) && $pro->grand_id != 0) {{ $getchildaname }} @endif</small>
								...
								<div class="col-md-3">
									...
									@if(count($pro->subvariants)>0)
		                                ...
		                                @if(isset($sub->variantimages['image2']))
		                                  ...
		                                  <img class="pro-img ximg2" title="{{ $pro->name }}" src="{{ url('variantimages/'.$sub->variantimages['image2']) }}" alt="{{ $sub->variantimages['image2'] }}">
...
<td>
						...
						<td class="align-middle">
							 ...
							 @php 
                                    ...
                                    {
                                      $url = '../../details/'.$pro->id.'?'.$name[0]['attr_name'].'='.$var_name[0];
                                    }
