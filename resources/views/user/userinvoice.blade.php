...
<body>
	<div class="container-fluid">
		...
		<div class="row justify-content-md-center">
			<div class="printheader offset-col-md-3 col-md-6">
				<br>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>
								<p><i class="{{ $getInvoice->order->paid_in }}"></i>{{ round($getInvoice->tax_amount,2) }}</p>
								@if($orivar->products->tax_r !='')
								<p>({{ $orivar->products->tax_name }})</p>
								<small class="help-block">({{ __('Tax Multiplied with Qty.') }})</small>
								@endif
							</td>
							<td>
