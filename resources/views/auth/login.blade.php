...
<div id="aniBox" class="col-md-6 col-sm-12 sign-in">
    ...
    <form method="POST" class="register-form outer-top-xs" role="form" action="{{ route('normal.login') }}">
                        @csrf
    ...
    <button type="submit" class="btn-upper btn btn-primary checkout-page-button">{{__('staticwords.Login')}}</button>
    </form>                 
</div>
<!-- Sign-in -->
