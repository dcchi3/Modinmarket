...
for (var i =0; i<atrbName.length; i++) {
  ...
  $.ajax({
        ...
        if (guestpricenable == "0" || login_check) {
          ...
          if(saleprice == 0)
        {
          $('.price-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+totalprice);
          variantofferprice = [];
          variantprice = [];
          ...
          $('.price-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+totalsaleprice);
          $('.price-strike-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+totalprice);
          variantofferprice = [];
          variantprice = [];
          ...
          $('.price-main').text('Login to view price');
        }
      @php
    }else{
      ...
      @endphp
       ...
       if(saleprice !=0){
        ...
        if(saleprice == 0)
        {
          $('.price-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+buyerprice);
          ...
          $('.price-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+buyersaleprice);
          $('.price-strike-main').append("<i class='{{session()->get('currency')['value']}}'></i>"+" "+buyerprice);
    ...
    @endphp
          ...
          if(saleprice == 0)
        {
          ...
          $('.price-main').html("<i class='{{session()->get('currency')['value']}}'></i>"+totalprice);
          variantofferprice = [];
          variantprice = [];
          ...
          $('.price-main').append("<i class='{{ session()->get('currency')['value'] }}'></i>"+" "+totalsaleprice);
          $('.price-strike-main').html("<i class='{{session()->get('currency')['value']}}'></i>"+" "+totalprice);
          variantofferprice = [];
          variantprice = [];
          variantofferprice.push(totalsaleprice);
          variantprice.push(totalprice);
...
@endphp
      ...
      $(".quant-input input").on('change',function(){
        ...
        $(".full_var_box div").each(function(i){
          ...
          $('.single-product-gallery-item').append('<center><img src='+url+'/'+data.variantimages['main_image']+' class="img zoom-img drift-demo-trigger" data-zoom='+url+'/'+data.variantimages['main_image']+'></center>');

          driftzoom();

            $('#pro_section').html('');
            $('#pro_section').append('<div id="pro-img"></div><div id="pro-title"></div>');
            $('#pro-img').append('<img height="30px" alt="product_img" src='+url+'/'+data.variantimages['main_image']+' title="{{ $pro->name }} ('+u2+')">');
            ...
            if (data == "") {
              $('.price').html('Price Not Available');
              $('.price-strike').html('');
              $('.quantity-container form').remove();
              ...
              swal({
                    title: "Sorry !",
                    text: ""+u2[0]+" Not Available In "+u2[1]+"",
                    icon: "warning"
                  });
                ...
                var tech = getUrlParameter(u[i]);
                 $('.xyz').each(function(index){
                  ...
                  if(a2 == tech){
                        ...
                        $(this).css({'padding' : "3px 8px", 'border' : 'solid 1px #147ED2', 'border-radius' : "0.5em", 'font-weight' : 'bold'});
                        $(this).attr('s', "1");
...
function tagfilter(d,attr,indexNum){
    ...
    @endphp
          ...
          if(saleprice == 0)
        {
          ...
          $('.price-main').text("<i class='{{session()->get('currency')['value']}}'></i>"+" "+totalprice);
          variantofferprice = [];
          variantprice = [];
...
@endphp
          ...
          $('.xyz').each(function(index){
            ...
            if(y==d)
            {
             ...
             $("#"+d+attr).attr('s', 1);
              var a = $("#"+d+attr).attr('s');
              if(a == 1){
                $(this).css({"padding" : "3px 8px","border" : "solid 1px transparent","background-color" : "white","font-weight" : "normal", "border-radius" : "0.3em"});

                  $("#"+d+attr).css({"padding" : "3px 8px", "border" : "solid 1px #147ED2", "border-radius" : "0.3em", "font-weight" : "bold"});
      ...
      varid.push(data['id']);
          ...
          driftzoom();
            ...
            $('#pro_section').html('');
            $('#pro_section').append('<div id="pro-img"></div><div id="pro-title">{{ $pro->name }} ('+u2+')</div>');
            $('#pro-img').append('<img height="30px" alt="product_img" src='+url+'/'+data.variantimages['main_image']+' title="{{ $pro->name }} ('+u2+')">');
      ...
      @endauth
       ...
       $(".quant-input input").on('change',function(){
        ...
        $('title').text(title+' - '+producttitle+' ('+u2+')');
        ...
        if (data == "") {
              ...
              if(indexNum == 0){
                ...
                $('.stockval').text("Not Available");
                  ...
                  swal({
                        title: "Sorry !",
                        text: "" +u2[1]+" Not Available In " +u2[0]+"",
                        icon: "warning"
                      });
              }
