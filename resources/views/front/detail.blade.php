                                  ...
                                  <!-- /.product-info -->
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                          ...
                                          @endif
                                         @else
                                            <h5>{{ __('staticwords.ComingSoon') }}</h5>
                                          @endif
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-xs-12 col-md-8">
                    <div class="price-box price-box-border">
                      ...
                      <span class="margin-top-15 font-size-20 price-strike price-strike-main"></span>
                            ...
                            <div class="col-lg-4 col-xs-4">
                              @foreach($pro->commonvars as $cvar)
                                <div class="size-heading">
                                   <label class="font-weight-bold">{{ $cvar->attribute->attr_name }}</label>
                                </div>
                              @endforeach
                            </div>
                             ...
                             <div class="col-lg-8 col-xs-8">
                              @foreach($pro->commonvars as $cvar)
                                  ...
                                  @if($cvar->attribute->attr_name == "Color" || $cvar->attribute->attr_name == "color" || $cvar->attribute->attr_name == "Colour" || $cvar->attribute->attr_name == "colour")
                                   ...
                                   <a class="pad3px8x margin-left15 avarbox" data-toggle="tooltip" data-placement="top" 
                                   ...
                                   @if(strcasecmp($cvar->provalues->values, $cvar->provalues->unit_value) !=0)    
                                    ...
                                    > <span class="ankit"><i style="color:{{ $cvar->provalues->unit_value }}" class="fa fa-circle"></i></span>
                                  ...
                                  @else
                                   ...
                                   <li class="size-one">
                                      ...
                                      @if(strcasecmp($cvar->provalues->values, $cvar->provalues->unit_value) !=0 && $cvar->provalues->unit_value != null)
                                        {{ $cvar->provalues->values }} {{ $cvar->provalues->unit_value }}
                                      @else
                                           {{ $cvar->provalues->values }}
                                      @endif
                     ...
                     @foreach($pro->variants as $key=> $mainvariant)
                      ...
                      @endphp
                       ...
                       <div class="row">
                         ...
                         <div class="col-lg-9">
                           <div class="blockVar size-options">
                        <ul>
                        ...
                        @foreach($pro->subvariants as $key=> $ss)
                            ...
                            @if($getvaluename->proattr->attr_name == "Color")
                             ...
                             <a class="avarbox xyz margin-left-minus-15 pad3px8x" 
                               data-toggle="tooltip" 
                               data-placement="top" 
                            ...
                            @else
                             ...
                             <li class="size-one">
                                 <a data-toggle="tooltip" data-placement="top" @if(strcasecmp($getvaluename->values, $getvaluename->unit_value) !=0)  title="{{ $getvaluename->values }} {{ $getvaluename->unit_value }}" @else title="{{ $getvaluename->values }}" @endif attr_id="{{ $getattrname->id }}" @if(strcasecmp($getvaluename->values, $getvaluename->unit_value) !=0) @if($getvaluename->proattr->attr_name == "Color") valname="{{ $getvaluename->values }}" @else valname="{{ $getvaluename->values }}{{ $getvaluename->unit_value }}" @endif @else valname="{{ $getvaluename->values }}" @endif val="{{ $getvaluename->id }}" name="{{ $getattrname->attr_name }}" class="xyz avarbox2" s="0" id="{{ $getattrname->attr_name }}{{ $getvaluename->id }}" onclick="tagfilter('{{ $getattrname->attr_name }}','{{ $getvaluename->id }}', '{{$indexNum}}')">
                       ...
                       <div class="product-image">
                        <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                 ...
                                 <a href="{{$url}}" title="{{$relproduct->name}}">
                                  ...
                                  @if(isset($orivar->variantimages['image2']))
                                   <img class="ankit {{ $orivar->stock ==0 ? "filterdimage" : ""}}" src="{{url('/variantimages/'.$orivar->variantimages['image2'])}}" alt="{{$relproduct->name}}">
                                   <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}} hover-image" src="{{url('/variantimages/'.$orivar->variantimages['image2'])}}" alt=""/>
                                  @endif
                       ...
                       <div class="product-image">
                        <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                 ...
                                 <a href="{{$url}}" title="{{$pro->name}}">
                                  ...
                                  @if(isset($orivar->variantimages['image2']))
                                   <img class="ankit {{ $orivar->stock ==0 ? "filterdimage" : ""}}" src="{{url('/variantimages/'.$orivar->variantimages['image2'])}}" alt="{{$pro->name}}">
                                   <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}} hover-image" src="{{url('/variantimages/'.$orivar->variantimages['image2'])}}" alt=""/>
                                  @endif
                       ...
                       @endphp
                          ...
                          <a href="{{$url}}" title="{{$value->pro->name}}">
                             @if(count($value->pro->subvariants)>0)
                                ...
                                @if(isset($orivar->variantimages['image2']))
                                 <img src="{{url('/variantimages/'.$orivar->variantimages['image2'])}}" alt="{{$value->name}}">
