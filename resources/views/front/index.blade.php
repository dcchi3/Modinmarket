     ...
     @include('front.layout.navbar')
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-10"> 
                ...
                @if(isset($getads))
                  @foreach($getads as $adv)
                   @if($adv->layout == 'Single image layout')
                      ...
                      <img class="img-fluid advertisement-img-one" src="{{ url('images/adv/'.$adv->image1) }}" alt="{{ $adv->image1 }}">
                    </a>
                         ...
                         <div class="col-md-6">
                          <a href="
                            ...
                            @else
                              {{ $adv->url1 }}
                            @endif" title="Click to visit">
                           <img class="img-fluid advertisement-img advertisement-img-one" src="{{ url('images/adv/'.$adv->image1) }}" alt="{{ $adv->image1 }}">
                         </a>
                         </div>
                         <div class="col-md-6">
                          <a href="
                            ...
                            @else
                              {{ $adv->url2 }}
                            @endif" title="Click to visit">
                           <img class="img-fluid advertisement-img advertisement-img-one" src="{{ url('images/adv/'.$adv->image2) }}" alt="{{ $adv->image2 }}">
                          </a>
                         </div>
                     </div>
                     <br>
                      ...
                      <div class="row">
                           <div class="col-md-8">
                            ...
                            @else
                              {{ $adv->url1 }}
                            @endif" title="Click to visit">
                              <img class="img-fluid advertisement-img advertisement-img-one advertisement-images-size-one" src="{{ url('images/adv/'.$adv->image1) }}" alt="{{ $adv->image1 }}">
                           </a>
                           </div>
                           <div class="col-md-4">
                            <a href="
                              ...
                              @else
                                {{ $adv->url2 }}
                              @endif" title="Click to visit">
                             <img class="img-fluid advertisement-images-size-one" src="{{ url('images/adv/'.$adv->image2) }}" alt="{{ $adv->image2 }}">
                            </a>
                           </div>
                       </div>
                       <br><br>
                ...
                <div id="hero">
                  <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    @foreach($slider as $sliders)
                      ...
                      @if($sliders->status == '1')
                         <div class="item backgroundcover" style="background-image: url('{{ url('images/slider/'.$sliders->image) }}');">
                            <div class="container-fluid">
                              <div class="caption bg-color vertical-center text-left">
                                <div class="slider-header fadeInDown-1"><span style="color:{{ $sliders->subheadingcolor }}">{{ $sliders->heading }}</span></div>
                                <div class="big-text fadeInDown-1"> <span style="color:{{ $sliders->headingtextcolor }}">{{ $sliders->topheading }}</span> </div>
                                <div class="excerpt fadeInDown-2 hidden-xs"> <span style="color:{{ $sliders->moredesccolor }}">{{ $sliders->moredesc }}</span> </div>
                                @if($sliders->buttonname !='')
                                <div class="button-holder fadeInDown-3"> <a style="background: {{ $sliders->btnbgcolor }};color:{{ $sliders->btntextcolor }}" href="@if($sliders->category_id != '') @include('front.layout.slidercaturl') @elseif($sliders->child != '') @include('front.layout.slidersubcaturl') @elseif($sliders->grand_id !='')  @include('front.layout.sliderchildcaturl') @elseif($sliders->product_id !='') @include('front.layout.sliderpro') @else {{ $sliders->url }} @endif" class="btn-lg btn btn-uppercase shop-now-button">{{ $sliders->buttonname }}</a> </div>
                                @endif
                              </div>
                              <!-- /.caption --> 
                            </div>
                ...
                <div class="more-info-tab clearfix ">
                  ...
                  <div class="wrapper">
                    <ul class="nav nav-pills float-right guu" id="new-products-1">
                      <li class="nav-item"><a class="nav-link active" data-transition-type="backSlide" href="#all" data-toggle="tab">{{ __('staticwords.All') }}</a></li>
                      
                     
                      @foreach($parents as $parent)
                         <?php $parentcats = App\Category::where('status','1')->where('id',$parent)->first(); ?>
                         @if(isset($parentcats))
                         <li class="nav-item"><a class="nav-link" data-transition-type="backSlide" href="#pro{{$parentcats->id}}" data-toggle="tab" title="{{$parentcats->title}}">{{$parentcats->title}}</a></li>
                         @endif
                      @endforeach
                              ...
                              <div class="product">
                               ...
                               <div class="product-image">
                                <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                         ...
                                         <a href="{{$url}}" title="{{$pro->name}}">
                                          ...
                                          @if(isset($orivar->variantimages['main_image']))
                                           <img class="ankit {{ $orivar->stock ==0 ? "filterdimage" : ""}}" src="{{url('variantimages/'.$orivar->variantimages['main_image'])}}" alt="{{$pro->name}}">
                                           <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}} hover-image" src="{{url('variantimages/'.$orivar->variantimages['image2'])}}" alt=""/>
                                          @endif
                                    ...
                                    @endif
                                     ...
                                     @if($orivar->stock != 0 && $orivar->products->selling_start_at != null && $orivar->products->selling_start_at >= $current_date)
                                ...
                                <div class="product-info text-left">
                                  <h3 class="name"><a href="{{ $url }}" title="{{$pro->name}}">{{substr($pro->name, 0, 20)}}{{strlen($pro->name)>20 ? '...' : ""}}</a></h3>
                                    <?php 
                                   ...
                                   <div class="cart clearfix animate-effect">
                                    <div class="action">
                                      ...
                                      @if(Auth::user()->wishlist->count()<1)
                                        ...
                                        <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.AddToWishList') }}" class="cursor-pointer add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Add to wishlist"> <i class="icon fa fa-heart"></i> 
                                        </a> 
                                        ...
                                        @endphp
                                          ...
                                          @if(!empty($ifinwishlist)) 
                                               <li class="lnk wishlist active">
                                                <a mainid="{{ $orivar->id }}"  title="{{ __('RemoveFromWishlist') }}" class="cursor-pointer color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> 
                                              </li>
                                          @else
                                              <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="cursor-pointer text-white add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Wishlist"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                          @endif

                                        @endif
                                      @endauth

                                        <li class="lnk"> <a class="add-to-cart" href="{{route('compare.product',$orivar->products->id)}}" title="{{ __('staticwords.Compare') }}"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                                      </ul>
                                    </div>
                                    <!-- /.action --> 
                                  </div>
                                   ...
                                   <div class="cart clearfix animate-effect">
                                    <div class="action">
                                      ...
                                      @if(Auth::user()->wishlist->count()<1)
                                        ...
                                        <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.AddToWishList') }}" class="cursor-pointer add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="{{ __('staticwords.AddToWishList') }}"> <i class="icon fa fa-heart"></i> 
                                        </a> 
                                      ...
                                      @else
                                        ...
                                        @endphp
                                          ...
                                          @if(!empty($ifinwishlist)) 
                                               <li class="lnk wishlist active">
                                                <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="cursor-pointer color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> 
                                              </li>
                                          @else
                                              <li class="lnk wishlist"> <a  title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="cursor-pointer text-white add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Wishlist"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                          @endif
                        ...
                        @if($pro->vender['role_id'] == 'a')
                          @foreach($pro->subvariants as $key=> $orivar)
                           @if($orivar->def ==1)
                            ...
                            try{
                              $url = url(url('details').'/').$pro->id.'?'.$name[0]['attr_name'].'='.$var_name[0].'&'.$name[1]['attr_name'].'='.$var_name[1];
                            }catch(Exception $e)
                            {
                            ...
                            <div class="product">
                              <div class="product-image">
                                <div class="image {{ $orivar->stock ==0 ? "pro-img-box" : ""}}"> 
                                       ...
                                       <a href="{{$url}}" title="{{$pro->name}}">
                                        ...
                                        @if(isset($orivar->variantimages['main_image']))
                                         <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}}" src="{{url('variantimages/'.$orivar->variantimages['main_image'])}}" alt="{{$pro->name}}">
                                         <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}}  hover-image" src="{{url('variantimages/'.$orivar->variantimages['image2'])}}" alt=""/>
                                        @endif
                              ...
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
                                     <li class="lnk wishlist"> 
                                         <form method="POST" action="{{route('add.cart',['id' => $pro->id ,'variantid' =>$orivar->id, 'varprice' => $show_price, 'varofferprice' => $convert_price ,'qty' =>$orivar->min_order_qty])}}">
                                          {{ csrf_field() }}
                                          <button title="{{ __('staticwords.AddtoCart') }}" type="submit" class="addtocartcus btn">
                                            <i class="fa fa-shopping-cart"></i>
                                          </button>
                                    ...
                                    @if(Auth::user()->wishlist->count()<1)
                                      ...
                                      <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.AddToWishList') }}" class="add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="icon fa fa-heart"></i> 
                                      </a> 
                                    ...
                                    @else
                                      ...
                                      @if(!empty($ifinwishlist)) 
                                           <li class="lnk wishlist active"> <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="{{ __('staticwords.Wishlist') }}"> <i class="icon fa fa-heart"></i> </a> 
                                          </li>
                                      @else
                                          <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Wishlist"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                      @endif
                                ...
                                <div class="action">
                                  <ul class="list-unstyled">
                                    ...
                                    @if(Auth::user()->wishlist->count()<1)
                                      ...
                                      <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.AddToWishList') }}" class="add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Add to wishlist"> <i class="icon fa fa-heart"></i> 
                                      </a> 
                                    ...
                                    @else
                                      ...
                                      @if(!empty($ifinwishlist)) 
                                           <li class="lnk wishlist active"> <a mainid="{{ $orivar->id }}"  title="Remove From wishlist" class="color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="{{ __('Wishlist') }}"> <i class="icon fa fa-heart"></i> </a> 
                                          </li>
                                      @else
                                          <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Wishlist"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                      @endif
                ...
                <div class="container">
                    <div class="row home-product-tab">
                        <ul class="nav nav-tabs">
                          <li class="nav-item tab-width"><a data-toggle="tab" class="nav-link active" href="#home">{{ __('staticwords.newprods') }}</a></li>
                          <li class="nav-item tab-width"><a class="nav-link" data-toggle="tab" href="#menu1">{{ __('staticwords.tpc') }}</a></li>
                          <li class="nav-item tab-width"><a class="nav-link" data-toggle="tab" href="#menu2">{{ __('staticwords.Featured') }}</a></li>
                        </ul>
                                                  ...
                                                  <div class="more-info-tab clearfix display-none">
                                                    ...
                                                    <div class="wrapper">
                                                      <ul class="nav nav-tabs nav-tab-line pull-right list" id="new-products-1">
                                                        <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">{{ __('staticwords.All') }}</a></li>
                                                        
                                                       
                                                        @foreach($parents as $parent)
                                                           <?php $parentcats = App\Category::where('status','1')->where('id',$parent)->first(); ?>
                                                           @if(isset($parentcats))
                                                           <li><a data-transition-type="backSlide" href="#pro{{$parentcats->id}}" data-toggle="tab" title="{{$parentcats->title}}">{{$parentcats->title}}</a></li>
                                                           @endif
                                                        @endforeach
                                                                      ...
                                                                      <div class="products">
                                                                        <div class="product">
                                                                         ...
                                                                         <div class="product-image">
                                                                          ...
                                                                          <div class="product-info text-left">
                                                                            <h3 class="name"><a href="{{ $url }}" title="{{$pro->name}}">{{ substr($pro->name,0,10) }}{{ strlen($pro->name)>10 ? "..." : "" }}</a></h3>
                                                                              <?php 
                                                                              $reviews = App\UserReview::where('pro_id',$pro->id)->where('status','1')->get();
                                                                              ?> @if(!empty($reviews[0]))<?php
                                                                              $review_t = 0;
                                                                              ...
                                                                              <div class="action">
                                                                                ...
                                                                                @else
                                                                                  ...
                                                                                  @endphp
                                                                                    ...
                                                                                    @if(!empty($ifinwishlist)) 
                                                                                         <li class="lnk wishlist active">
                                                                                          <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="color000 cursor-pointer add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="{{ __('staticwords.Wishlist') }}"> <i class="icon fa fa-heart"></i> </a> 
                                                                                        </li>
                                                                                    @else
                                                                                        <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish cursor-pointer text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                                                    @endif
                                                                             ...
                                                                             <div class="cart clearfix animate-effect">
                                                                              <div class="action">
                                                                                ...
                                                                                @if(Auth::user()->wishlist->count()<1)
                                                                                  ...
                                                                                  <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.AddToWishList') }}" class="cursor-pointer add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="icon fa fa-heart"></i> 
                                                                                  </a> 
                                                                                ...
                                                                                @else
                                                                                  ...
                                                                                  @endphp
                                                                                    ...
                                                                                    @if(!empty($ifinwishlist)) 
                                                                                         <li class="lnk wishlist active">
                                                                                          <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="color000 cursor-pointer add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}"> <i class="icon fa fa-heart"></i> </a> 
                                                                                        </li>
                                                                                    @else
                                                                                        <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish cursor-pointer text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                                                    @endif
                                                                    ...
                                                                    <div class="action">
                                                                      <ul class="list-unstyled">
                                                                        ...
                                                                        @else
                                                                          ...
                                                                          @if(!empty($ifinwishlist)) 
                                                                               <li class="lnk wishlist active"> <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}"> <i class="icon fa fa-heart"></i> </a> 
                                                                              </li>
                                                                          @else
                                                                              <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="text-white add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                                          @endif
                                                                    ...
                                                                    <div class="action">
                                                                      <ul class="list-unstyled">
                                                                        ...
                                                                        @else
                                                                          ...
                                                                          @if(!empty($ifinwishlist)) 
                                                                               <li class="lnk wishlist active"> <a mainid="{{ $orivar->id }}"  title="{{ __('staticwords.RemoveFromWishlist') }}" class="color000 add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> 
                                                                              </li>
                                                                          @else
                                                                              <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="text-white add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="Wishlist"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                                          @endif
                                    ...
                                    @foreach($featureds as $featured)
                                       @foreach($featured->subvariants as $key=> $orivar)
                                           @if($orivar->def ==1)
                                              ...
                                              try{
                                                $url = url('details').'/'.$featured->id.'?'.$name[0]['attr_name'].'='.$var_name[0].'&'.$name[1]['attr_name'].'='.$var_name[1];
                                              }catch(Exception $e)
                                              {
                                             ...
                                             <div class="product-image">
                                                      <div class="image {{ $orivar->stock ==0 ? "pro_img-box" : ""}}"> 
                                                             ...
                                                             <a href="{{$url}}" title="{{$featured->name}}">
                                                              ...
                                                              @if(isset($orivar->variantimages['main_image']))
                                                               <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}}" src="{{url('variantimages/'.$orivar->variantimages['main_image'])}}" alt="{{$featured->name}}">
                                                               <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}}  hover-image" src="{{url('variantimages/'.$orivar->variantimages['image2'])}}" alt=""/>
                                                              @endif

                                                              @else
                                                              <img class="{{ $orivar->stock ==0 ? "filterdimage" : ""}}" title="{{ $featured->name }}" src="{{url('images/no-image.png')}}" alt="No Image"/>
                                              ...
                                              <div class="product-info text-left">
                                                <h3 class="name"><a href="{{$url}}">{{ substr($featured->name,0,10) }}{{ strlen($featured->name)>10 ? "..." : "" }}</a></h3>
                                                <?php 
                                                        $review_t = 0;
                                                        $price_t = 0;
                                                        $value_t = 0;
                                                    ...
                                                    @if(!empty($auth))
                                                         <?php $cart_table = App\Cart::where('user_id',$auth->id)->where('pro_id',$featured->id)->first(); ?>@endif
                                                          ...
                                                          <li id="addCart" class="lnk wishlist"> 
                                                             ...
                                                             @if($price_login != 1)
                                                              <form method="POST" action="{{route('add.cart',['id' => $featured->id ,'variantid' =>$orivar->id, 'varprice' => $show_price, 'varofferprice' => $convert_price ,'qty' =>$orivar->min_order_qty])}}">
                                                                {{ csrf_field() }}
                                                                <button title="{{ __('staticwords.AddtoCart') }}" type="submit" class="addtocartcus btn">
                                                                  <i class="fa fa-shopping-cart"></i>
                                                                </button>
                                                          ...
                                                          @else
                                                          <li id="addCart" class="lnk wishlist"> <a class="add-to-cart" href="{{url('remove_table_cart/'.$orivar->id)}}" title="{{ __('Remove Cart') }}"> <i class="icon fa fa-times"></i> </a> </li>
                                                          @endif
                                                         ...
                                                         @auth
                                                          ...
                                                          @else
                                                            ...
                                                            @endphp
                                                              ...
                                                              @if(!empty($ifinwishlist)) 
                                                                   <li class="lnk wishlist active">
                                                                    <a mainid="{{ $orivar->id }}"  title="{{ __('RemoveFromWishlist') }}" class="color000 cursor-pointer add-to-cart removeFrmWish active" data-remove="{{url('removeWishList/'.$orivar->id)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> 
                                                                  </li>
                                                              @else
                                                                  <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="text-white cursor-pointer add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                              @endif

                                                            @endif
                                                          @endauth
                                                          <li class="lnk"> <a class="add-to-cart" href="{{route('compare.product',$featured->id)}}" title="{{ __('staticwords.Compare') }}"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                                                        </ul>
                                                </div>
                                                <!-- /.action --> 
                                              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4">
                    ...
                    <div class="wide-banner cnt-strip">
                      <a href="@if($adv->link_by=='cat') @include('front.advcaturl') @elseif($adv->link_by=='pro') @include('front.advvarurl') @else{{$adv->url}}@endif">
                         ...
                         <div class="col-md-6">
                          <a href="
                            ...
                            @else
                              {{ $adv->url1 }}
                            @endif" title="Click to visit">
                           <img class="img-fluid advertisement-img-one advertisement-img" src="{{ url('images/adv/'.$adv->image1) }}" alt="{{ $adv->image1 }}">
                         </a>
                         </div>
                         <div class="col-md-6">
                          <a href="
                                            ...
                                            <div class="action">
                                              <ul class="list-unstyled">
                                                ...
                                                @else
                                                  ...
                                                  @else
                                                      <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                                  @endif
        ...
        @if(count($blogs)>0)
          ...
          <a title="View all posts" href="{{ route('front.blog.index') }}" class="pull-right btn btn-md btn-info">{{ __('staticwords.vall') }}</a>
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"><a title="{{$blog->heading}}" href="{{ route('front.blog.show',$blog->slug) }}"><img src="{{url('images/blog/'.$blog->image)}}" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
                  ...
                  <div class="blog-post-info text-left">
                    ...
                    <span class="info">{{ __('staticwords.by') }} {{$blog->user}} &nbsp;|&nbsp; {{$blog->created_at->format('d/m/Y')}}</span>
                    <p class="text"> {{substr(strip_tags($blog->des),0,50)}}{{strlen(strip_tags($blog->des))>50 ? "..." : ""}} </p>
                   </div>
                  <!-- /.blog-post-info --> 
              ...
              <div class="products">
                <div class="product">
                 <div class="product-image">
                  ...
                  <div class="product-info text-left">
                    <h3 class="name"><a href="{{$url}}">{{substr($featured->name, 0, 20)}}{{strlen($featured->name)>20 ? '...' : ""}}</a></h3>
                    <?php 
                            $review_t = 0;
                            $price_t = 0;
                            $value_t = 0;
                        ...
                        @if(!empty($auth))
                             ...
                             @auth
                              @if(Auth::user()->wishlist->count()<1)
                                ...
                                <a mainid="{{ $orivar->id }}" class="cursor-pointer add-to-cart addtowish" data-add="{{url('AddToWishList/'.$orivar->id)}}" title="{{ __('staticwords.AddToWishList') }}"> <i class="icon fa fa-heart"></i> 
                                </a> 
                              ...
                              @else
                                ...
                                @endphp
                                  ...
                                  @if(!empty($ifinwishlist)) 
                                       <li class="lnk wishlist active">
                                        <a mainid="{{ $orivar->id }}" title="{{ __('staticwords.RemoveFromWishlist') }}" class="add-to-cart removeFrmWish active color000 cursor-pointer" data-remove="{{url('removeWishList/'.$orivar->id)}}"> <i class="icon fa fa-heart"></i> </a> 
                                      </li>
                                  @else
                                      <li class="lnk wishlist"> <a title="{{ __('staticwords.AddToWishList') }}" mainid="{{ $orivar->id }}" class="add-to-cart addtowish cursor-pointer text-white" data-add="{{url('AddToWishList/'.$orivar->id)}}"> <i class="activeOne icon fa fa-heart"></i> </a></li>
                                  @endif
           ...
           @if($adv->layout == 'Single image layout')
              <a href="
                ...
                @else
                  {{ $adv->url1 }}
                @endif" title="Click to visit">
              <img class="img-fluid single-image-layout advertisement-img advertisement-img-one" src="{{ url('images/adv/'.$adv->image1) }}" alt="{{ $adv->image1 }}">
            </a>
