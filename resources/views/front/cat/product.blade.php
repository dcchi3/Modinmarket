                          ...
                          <div class="image {{ $sub->stock ==0 ? "pro_img-box" : ""}}"> 
                                 ...
                                 <a href="{{$url}}" title="{{$product->name}}">
                                  ...
                                  @if(isset($sub->variantimages['main_image']))
                                   <img class="{{ $sub->stock == 0 ? "filterdimage" : ""}}" src="{{url('variantimages/'.$sub->variantimages['main_image'])}}" alt="{{$sub->products->name}}">
                                   <img class="{{ $sub->stock ==0 ? "filterdimage" : ""}}  hover-image" src="{{url('variantimages/'.$sub->variantimages['image2'])}}" alt=""/>
                                  @endif
                                            ...
                                            <div class="image">
                                                <a href="{{ url($url) }}">
                                                    ...
                                                    <div class="pro_img-box">
                                                        ...
                                                        @if(isset($sub->variantimages['main_image']))
                                                         <img class="filterdimage" src="{{url('variantimages/'.$sub->variantimages['main_image'])}}" alt="{{$product->name}}">
                                                         <img class="filterdimage hover-image" src="{{url('variantimages/'.$sub->variantimages['image2'])}}" alt=""/>
                                                        @endif
