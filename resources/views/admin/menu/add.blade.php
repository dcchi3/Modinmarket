                      ...
                      if($t == 1){
                        ...
                        @endphp
                           <div class="col-md-12 sub-cat-sel">
                            <label><input type="checkbox" name="child_cat[]" class="categories_panel required_one sub_categories sub_categories_{{$item->id}}" parents_id = "{{$item->id}}" value="{{$single_data['id']}}">&nbsp;{{$single_data['title']}}</label>
                          </div>
                        @php
                      }else{
                        for ($j; $j < $t; $j += 2) {
                          ...
                          <div class="col-md-6 sub-cat-sel">
                            <label><input type="checkbox" name="child_cat[]" class="categories_panel required_one sub_categories sub_categories_{{$item->id}}" parents_id = "{{$item->id}}" value="{{$left_row['id']}}">&nbsp;{{$left_row['title']}}</label>
                          </div>
                            @php
                          $i += 2;
                          ...
                          @endphp
                          <div class="col-md-6 sub-cat-sel">
                            <label><input type="checkbox" name="child_cat[]" class="categories_panel required_one sub_categories sub_categories_{{$item->id}}" parents_id = "{{$item->id}}" value="{{$right_row['id']}}">&nbsp;{{$right_row['title']}}</label></div>
