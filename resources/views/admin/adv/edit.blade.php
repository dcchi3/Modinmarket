            ...
            <div class="row">
              ...
              <div class="col-md-4">
                      ...
                      <div id="urlbox1" class="form-group {{ $adv->url1 != '' ? "" : 'display-none' }}">
                        ...
                        <input value="{{ $adv->url1 }}" class="form-control" type="url" placeholder="http://" name="url1">
                      </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div id="urlbox2" class="form-group {{ $adv->url2 != '' ? "" : 'display-none' }}">
                  <label>Enter URL:</label>
                  <input value="{{ $adv->url2 }}" class="form-control" type="url" placeholder="http://" name="url2">
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div id="urlbox3" class="form-group {{ $adv->url3 != '' ? "" : 'display-none' }}">
                  <label>Enter URL:</label>
                  <input value="{{ $adv->url3 }}" class="form-control" type="url" placeholder="http://" name="url3">
                </div>
              </div>
            </div>
...
@section('custom-script')
 ...
 <script src="{{ url('js/advertise.js') }}"></script>
@endsection