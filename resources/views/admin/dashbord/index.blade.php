          ...
          @if($dashsetting->tw_wid==1)
            ...
            <div class="info-box-content">
              ...
              @if($dashsetting->tw_username != '')
                ...
                @if($connected)
                <?php 
                  $tw_username = "$dashsetting->tw_username"; 
          ...
          @if($dashsetting->insta_wid==1)
            ...
            <div class="info-box-content">
              <span class="info-box-text">Followers</span>
                ...
                @if($connected)
                  <?php
                    $raw = file_get_contents("https://www.instagram.com/$dashsetting->inst_username"); //replace with user
            ...
            <!-- /.box-header -->
             <div class="pbox box-body">
              <ul class="products-list product-list-in-box">
                @php
                  $products = App\Product::orderBy('id', 'desc')->take($dashsetting->max_item_pro)->get();
                @endphp
