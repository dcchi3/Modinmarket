          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                ...
                <li><a href="#">Total Orders <span class="pull-right badge bg-green">12</span></a></li>
                <li><a href="#">Total Products <span class="pull-right badge bg-aqua">{{ $store->products->count() }}</span></a></li>
          ...
          <div class="box box-primary" >
            <div class="box-header with-border">
                  ...
                  <div class="box-body">
                    ...
                    <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/stores/'.$store->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                        {{csrf_field()}}
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <label class="control-label" for="first-name">
                         ...
                         <input placeholder="Please enter store name" type="text" id="first-name" name="name" class="form-control" value="{{$store->name}}">
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <input placeholder="Please enter buisness email" type="email" id="first-name" name="email" class="form-control" value="{{$store->email}}">
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          ...
                          <div class="col-custom col-md-2">
                             <img src=" {{ $image ? url('images/store/'.$store->store_logo) : Avatar::create($store->name)->toBase64() }} "height="50px" width="70px"/>
                          </div>
                        </div>
                      </div>
                        ...
                        <input pattern="[0-9]+" title="Invalid phone no." placeholder="Please enter phone no." type="text" id="first-name" name="phone" class="form-control" value="{{$store->phone}}">
                        </div>
                        ...
                        <div class="col-md-4">
                          ...
                          <textarea rows="1" cols="1" placeholder="Please enter address" type="text" id="first-name" name="address" class="form-control">{{$store->address}}</textarea>
                      ...
                      <div class="col-md-4">
                        ...
                        <input pattern="[0-9]+" title="Invalid Pincode/ zipcode" placeholder="Please enter pincode" type="text" id="first-name" name="pin_code" value="{{$store->pin_code}}" class="form-control"/>
                      ...
                      <div class="col-md-4">
                        ...
                        <input title="enter paypal email" placeholder="enter paypal email" type="email" name="paypal_email" value="{{$store->paypal_email}}" class="form-control"/>
                      ...
                      <div class="col-md-4">
                        ...
                        <input name="paytem_mobile" pattern="[0-9]+" title="enter valid paytm mobile no" placeholder="enter paytm no (KYC verified)" type="text" value="{{$store->paytem_mobile}}" class="form-control"/>
                      ...
                      <div class="col-md-3">
                         ...
                         <input <?php echo ($store->status=='1')?'checked':'' ?> id="toggle-event3" type="checkbox" class="tgl tgl-skewed">
                      ...
                      <div class="col-md-3">
                        ...
                        <input <?php echo ($store->verified_store=='1')?'checked':'' ?> id="toggle-event5" type="checkbox" class="tgl tgl-skewed">
                      ...
                      <div class="col-md-3">
                        ...
                        <input <?php echo ($store->apply_vender=='1')? 'checked' :'' ?> id="toggle-event6" type="checkbox" class="tgl tgl-skewed" name="apply_vender">
                      ...
                      <div class="last_btn col-md-4">
                        <button @if(env('DEMO_LOCK') == 0) type="submit" @else disabled="" title="This action is disabled in demo !" @endif class="btn btn-primary btn-block col-md-4">
