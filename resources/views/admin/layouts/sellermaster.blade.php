  ...
  <header class="main-header">
    ...
    <a href="{{ route('seller.dboard') }}" class="logo">
      ...
      <span class="logo-mini">
        <img title="{{ config('app.name') }}" width="20px" src="{{ url('images/genral/'.$genrals_settings->fevicon) }}" alt=""/>
      </span>
  
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"> <img title="{{ config('app.name') }}" width="20px" src="{{ url('images/genral/'.$genrals_settings->fevicon) }}" alt=""/> {{$genrals_settings->project_name}}</span>
    </a>
...
<img src="@auth @if($userimage){{url('images/user/'.Auth::user()->image)}} @else {{ Avatar::create(Auth::user()->name)->toBase64() }} @endif" class="img-circle" alt="User Image" width="22px"> <span class="hidden-xs">Hi ! {{ Auth::user()->name }} @endauth</span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                @else
                <img class="img-circle" title="{{ Auth::user()->name }}" src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" />
                @endif
                <p>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ Nav::isRoute('seller.dboard') }}"><a href="{{route('seller.dboard')}} "><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
          <li class="{{ Nav::isRoute('get.profile') }}"><a href="{{route('get.profile')}} "><i class="fa fa-user-circle" aria-hidden="true"></i>
          <span>Profile</span></a></li>
        <li class="{{ Nav::isResource('store') }}"><a href="{{route('store.index')}} "><i class="fa fa-address-card-o" aria-hidden="true"></i>
 <span>Your Store</span> </a></li>
 
  
  <li class="treeview {{ Nav::isRoute('seller.get.categories') }} {{ Nav::isRoute('seller.get.subcategories') }} {{ Nav::isRoute('seller.get.childcategories') }} {{ Nav::isRoute('seller.brand.index')  }} {{ Nav::isRoute('seller.pro.vars.all')  }} {{ Nav::isRoute('products.create') }} {{ Nav::isResource('my/products/') }} {{ Nav::isRoute('seller.import.product') }} {{ Nav::isRoute('seller.add.var') }} {{ Nav::isRoute('seller.manage.stock') }} {{ Nav::isRoute('seller.edit.var') }} {{ Nav::isRoute('seller.pro.vars.all') }} {{ Nav::isRoute('seller.product.attr') }}">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                      <li class="{{ Nav::isRoute('seller.brand.index')  }}"><a href="{{ route('seller.brand.index') }}"><i class="fa fa-circle-o"></i>Brands</a></li>
                      <li class="{{ Nav::isRoute('seller.pro.vars.all')  }} {{ Nav::isResource('my/products/') }}"><a href="{{route('products.index')}} "><i class="fa fa-circle-o"></i><span>Products</span></a></li>
                      ...
                      <li class="treeview {{ Nav::isRoute('seller.get.categories') }} {{ Nav::isRoute('seller.get.subcategories') }} {{ Nav::isRoute('seller.get.childcategories') }}">
                        ...
                        <ul class="treeview-menu">
                          <li class="{{ Nav::isRoute('seller.get.categories') }}" ><a href="{{route('seller.get.categories')}}"><i class="fa fa-circle-o"></i>Categories</a></li>
                          <li class="{{ Nav::isRoute('seller.get.subcategories') }}"><a href="{{route('seller.get.subcategories')}}"><i class="fa fa-circle-o"></i>Subcategories</a></li>
                          <li class="{{ Nav::isRoute('seller.get.childcategories') }}"><a href="{{route('seller.get.childcategories')}}"><i class="fa fa-circle-o"></i>Childcategories</a></li>
                        </ul>
                      </li>
                      
                      <li class="{{ Nav::isRoute('seller.product.attr') }}"><a href="{{route('seller.product.attr')}} "><i class="fa fa-circle-o"></i><span>Product Attributes</span></a></li>            
          
                      <li class="{{ Nav::isRoute('seller.import.product') }}">
                        <a href="{{route('seller.import.product')}} "><i class="fa fa-circle-o"></i><span>Import Products</span></a>
                      </li>
        ...
        <li class="treeview {{ Nav::isResource('order') }} {{ Nav::isRoute('seller.canceled.orders') }}">
          ...
          <ul class="treeview-menu">
              <li class="{{ Nav::isResource('order') }}">
                <a href="{{url('seller/orders')}} "><i class="fa fa-circle-o" aria-hidden="true"></i> <span>Orders</span> </a>
              </li>
        ...
        <li class="{{ Nav::isRoute('vender.invoice.setting') }}"><a href="{{ route('vender.invoice.setting') }}"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span>Invoice Setting</span></a></li>

        <li class="{{ Nav::isRoute('seller.shipping.info') }}"><a href="{{ route('seller.shipping.info') }}"><i class="fa fa-cubes" aria-hidden="true"></i> <span>Shipping Information</span></a></li>
        
                     <li class="treeview {{ Nav::isRoute('seller.commission') }} {{ Nav::isRoute('vender.payout.show.complete') }} {{ Nav::isRoute('seller.payout.index') }}">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                     <li class="{{ Nav::isRoute('vender.payout.show.complete') }} {{ Nav::isRoute('seller.payout.index') }}"><a href="{{route('seller.payout.index')}} "><i class="fa fa-circle-o"></i>Payouts</a></li>
                     <li class="{{ Nav::isRoute('seller.commission') }}"><a href="{{ route('seller.commission') }}"><i class="fa fa-circle-o"></i> Commissions </a></li>
...
<footer class="main-footer">
    ...
    <span class="pull-right"><b>v1.2</b></span>
  </footer>
