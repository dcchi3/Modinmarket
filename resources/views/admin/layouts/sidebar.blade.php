    ...
    <ul class="treeview-menu">
     ...
     <li class="{{ Nav::isRoute('front.slider') }}">
       ...
       <li class="{{ Nav::isRoute('pwa.setting.index') }}"><a title="Progressive Web App Setting" href="{{route('pwa.setting.index')}} "><i class="fa fa-delicious" aria-hidden="true"></i><span>PWA Settings</span></a></li>
        ...
        <li id="sitesetting" class="treeview {{ Nav::isRoute('customstyle') }} {{ Nav::isRoute('site.lang') }} {{ Nav::isResource('admin/abuse') }} {{ Nav::isResource('admin/bank_details') }} {{ Nav::isRoute('genral.index') }} {{ Nav::isRoute('mail.getset') }} {{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('footer.index') }} {{ Nav::isResource('social') }} {{ Nav::isResource('page') }} {{ Nav::isResource('blog') }} {{ Nav::isRoute('seo.index') }} {{ Nav::isRoute('api.setApiView') }} {{ Nav::isRoute('get.paytm.setting') }} {{ Nav::isResource('page') }} {{ Nav::isRoute('admin.dash') }} {{ Nav::isRoute('static.trans')  }}">
          <a href="#">
         ...
         <li id="paymentset" class="treeview {{ Nav::isRoute('paypalandstripe') }} {{ Nav::isRoute('get.rpay.setting') }} {{ Nav::isRoute('api.setApiView') }} {{ Nav::isRoute('get.paytm.setting') }}"><a href="#"><i class="fa fa-money"></i><span>Payment Gateway Settings</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu ">
                <li class="{{ Nav::isRoute('paypalandstripe') }}"><a href="{{route('paypalandstripe')}}"><i class=" fa fa-circle-o"></i>PayPal & Strip</a></li>
                
                <li class="{{ Nav::isRoute('get.paytm.setting') }}"><a href="{{route('get.paytm.setting')}}"><i class=" fa fa-circle-o"></i>PayU Money & Instamojo</a></li>

                <li class="{{ Nav::isRoute('get.rpay.setting') }}"><a href="{{route('get.rpay.setting')}}"><i class=" fa fa-circle-o"></i>RazorPay & Paytm Setting</a></li>
              </ul>
            </li>

        <li id="widgets" class="treeview {{ Nav::isRoute('sp.offer.widget') }} {{ Nav::isResource('admin/widget') }} {{ Nav::isResource('admin/NewProCat') }}">
          <a href="#">
            <i class="fa fa-gg" aria-hidden="true"></i><span>Widgets</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
          <ul class="treeview-menu">
            ...
            <li class="{{ Nav::isRoute('sp.offer.widget') }}"><a href="{{route('sp.offer.widget')}}"><i class="fa fa-circle-o"></i>Special Offer Widgets</a></li>
           
            <li class="{{ Nav::isResource('admin/NewProCat') }}"><a href="{{url('admin/NewProCat')}}"><i class="fa fa-circle-o"></i>New Product Categories</a></li>
           
           
            
            <li class="{{ Nav::isResource('admin/widget') }}"><a href="{{url('admin/widget')}} "><i class="fa fa-circle-o"></i>Widget Settings</a></li>
