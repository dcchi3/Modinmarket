<br>
<form id="demo-form2" method="post" enctype="multipart/form-data" @if(!empty($products)) action="{{url('admin/products/'.$products->id)}}" @endif data-parsley-validate class="form-horizontal form-label-left">
                        {{csrf_field()}}
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="margin-top-15 col-md-4">
                          ...
                          <select required="" name="child" id="upload_id" class="form-control">
                            <option value="">Please Select</option>
                            @if(!empty($child))
                        ...
                        <div class="margin-top-15 col-md-4">
                         ...
                         Childcategory:
                          ...
                          <select name="grand_id" id="grand" class="form-control">
                      ...
                      <div class="margin-top-15 col-md-6">
                        ...
                        Tags:
                         ...
                         <input value="{{ $products->tags }}" placeholder="Please enter tag seprated by Comma(,)" type="text" name="tags" class="form-control">
                      ...
                      <div class="margin-top-15 col-md-12">
                       ...
                       <div class="margin-top-15 col-md-12">
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <input pattern="[0-9]+(\.[0-9][0-9]?)?" title="Price Format must be in this format : 200 or 200.25" required="" type="text" id="first-name" name="price" value="{{$products->vender_price ?? ''}}" class="form-control">
                           <br>
                        ...
                        <div class="margin-top-15 col-md-6">
                          ...
                          <input {{ $products->tax_r != '' ? "required" : "" }} type="text" id="tax_name" class="form-control" name="tax_name" title="Tax rate must without % sign" placeholder="Enter Tax Name" value="{{ $products->tax_name }}">
                        </div>
                       ...
                       <div id="policy" class="@if(!empty($products)) {{ $products->return_avbl==1 ? '' : 'display-none' }}  @else 'display-none' @endif last_btn col-md-6">
                        <label>
                        ...
                        <div class="margin-top-15 col-md-12">
                           <button @if(env('DEMO_LOCK') == 0) type="submit" @else title="This action is disabled in demo !" @endif class="col-md-4 btn btn-block btn-primary"><i class="fa fa-save"></i> Update Product</button>
                        </div>
