...
Route::group(['middleware' => ['web','isActive','IsInstalled','auth','is_admin','optimizeImages','switch_lang']], function(){
...
Route::get('/admin/razorpay/setting','KeyController@razorpay')->name('get.rpay.setting');
...
Route::delete('product/bulk_delete', 'ProductController@bulk_delete')->name('pro.bulk.delete');
Route::get('admin/payu-insta-key-setting','KeyController@payuInsta_show')->name('get.paytm.setting');
Route::post('admin/payu-insta-key-setting','KeyController@payuInsta')->name('store.other.keys');
...
Route::resource("admin/group_specifications","GroupSpecificationController");
...
Route::resource("admin/specifiction_product","SpecifictionProductController");
Route::get("admin/specifiction_products/{id}","SpecifictionProductController@create");
...
Route::get("admin/only_user","UserController@only_user")->name('onlyshowuser');
Route::get("admin/only_vender","UserController@only_vender")->name('show.allvenders');
...
Route::group(['middleware' => ['web', 'isActive','IsInstalled','auth', 'is_vendor','optimizeImages','switch_lang']], function() {
  ...
  Route::resource("my/products","VenderProductController");
  ...
  Route::resource("return","VendorReturnController");
...
Route::get('/admin/mail-settings','Configcontroller@getset')->name('mail.getset');
 ...
 Route::get('/admin/paypal-stripe','KeyController@setApiView')->name('paypalandstripe');
 Route::post('admin/api','KeyController@saveKeys')->name('api.change');
