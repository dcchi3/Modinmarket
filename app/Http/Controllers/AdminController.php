...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.dashbord.index", compact('latestorders','filterpayout', 'product', 'order', 'user', 'store', 'coupan', 'category', 'totalcancelorder', 'faqs', 'inv_cus', 'userchart','piechart','orderchart','storerequest'));
    }
